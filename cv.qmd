...
-   **R** (The mail tool I use for data science & analysis)
    ...
    -   Spatial data analysis:
        ...
        -   Raster Data (`terra`)
-   **mySQL** (Data management and Manipulation)
-   **R Markdown** (Creating dynamic reports and documentations)
-   **Quarto** (Developing websites and presentations)
